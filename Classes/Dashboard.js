        ...
        userRef
          ...
          .then((snapshot) => {
            ...
            if (isFirstTimeLogin) {
              ...
              Alert.alert('Please complete your profile: Enter Disease and Phone_Number ', '', [
                {
                  text: 'OK',
  ...
  return (
    <View style={styles.Dashboard}>
      ...
      <View style={styles.medicalcheck}>
        ...
        <Text style={{ color: 'white', marginTop: 35, alignItems: 'center', fontSize: 16 }}>
          {' '}
        ...
        <View style={styles.imageandbutton}>
          <View style={styles.BookAppointmentViewbtn}>
            <TouchableOpacity style={{ backgroundColor: 'white', borderRadius: 16, marginTop: 55, marginLeft: 8 }} onPress={() => handleNavigation('Detector')}>
              <Text
                style={{
                  color: '#d34b4b',
                  textAlign: 'center',
